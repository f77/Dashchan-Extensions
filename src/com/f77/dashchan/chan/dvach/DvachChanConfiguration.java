...
public class DvachChanConfiguration extends ChanConfiguration {
    ...
    private List<String> boardsWithRating;
    ...
    public DvachChanConfiguration() {
        ...
        boardsWithRating = Arrays.asList("po", "news", "hry", "d");
    }
    ...
    public Board obtainBoardConfiguration(String boardName) {
        ...
        board.allowWatchRating = false;
        board.allowChangeRating = false;
        if (boardsWithRating.contains(boardName)) {
            board.allowWatchRating = true;
            board.allowChangeRating = true;
        }
        return board;
    }
